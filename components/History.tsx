...
const History = () => {
  ...
  const fetchUsers = async (page: SetStateAction<number>) => {
    try {
      setLoading(true);
      setError(null);
      ...
      setTotalUsers(countResponse.data.length);
  ...
  const renderTableHeader = () => (
    <tr>
      <th scope="col" className="text-gray-600 w-[10%] px-3 py-3">
        Source
      </th>
      <th scope="col" className="text-gray-600 px-3 py-3">
        Result
      </th>
      <th scope="col" className="text-gray-600 px-3 py-3">
        Name
            ...
            {users.map((user: any) => (
              <tr key={user.id} className="border-b text-black font-semibold">
                ...
                <td className="py-2 px-2 flex justify-center items-center">
                  <button
                    className={`py-2 px-2 md:px-1 w-full text-xs whitespace-nowrap rounded-lg border border-red-500 text-red-500`}
                  >
                    Validate email
                  </button>
                </td>
                ...
                <Pagination>
                  <PaginationContent>
                    ...
                    <PaginationItem>
                      <PaginationLink
                        isActive
                        className="bg-red-200 border border-red-500 text-red-500 hover:border-0"
                      >
                        {" "}
                        {currentPage}
                      </PaginationLink>
                      ...
                      <PaginationNext
                        ...
                        className={
                          currentPage === totalPages
                            ...
                            : "cursor-pointer bg-red-200 border border-red-500 text-red-500 hover:border-0"
                        }
                      />
                    </PaginationItem>
                  </PaginationContent>
